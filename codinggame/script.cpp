    ...
    public:
        ...
        void    j_j(entity *arg){
            ...
            for(;map_toj.size() && mana >= 10;){
                ...
                double xxi = ebase_x - (((dist_eb + 1200) * ( ebase_x - (elem->x + elem->vx))) / dist_eb);
                double xi = ebase_x - (((dist_eb - 1100) * ( ebase_x - (elem->x + elem->vx))) / dist_eb);
                double yyi = ebase_y - (((dist_eb + 1200) * ( ebase_y - (elem->y + elem->vy))) / dist_eb);
                ...
                else if (mana > 19 && launching == false && arg->dist(elem) >= 1280 && wind_dist <= 800  && !elem->type  && elem->health > 8 && elem_d_base_c < heros_d_base  && (elem_d_base_c < 6000 || around)){
                ...
                else if (launching == false && !elem->type && elem->health > 8 && arg->dist(elem) <= 1280 && (launcher_ready || elem_d_base < 6000 || around)){
                    if (launcher_ready)
